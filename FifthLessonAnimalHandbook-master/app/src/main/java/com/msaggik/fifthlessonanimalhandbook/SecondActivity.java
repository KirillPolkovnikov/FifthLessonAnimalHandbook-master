...
public class SecondActivity extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        animals.add(new Animal("Заяц", "Заяц – дикое животное, относящееся к классу млекопитающих, отряду зайцеобразных. Отличительная черта этого зверя – длинные уши, длинные задние лапы и короткий хвост",
                R.drawable.hare,"Численность средняя"));
        animals.add( new Animal("Бобр", "Полуводное млекопитающее отряда грызунов",
                R.drawable.beaver, "Численность большая"));
        animals.add( new Animal("Медведь", "Семейство млекопитающих отряда хищных. Отличаются от других представителей псообразных более коренастым телосложением",
        ...
        animals.add(new Animal("Муравьед","Муравьеды — небольшие млекопитающие, характеризующиеся длинным и изогнутым носом. Они обитают в тропических лесах Центральной и Южной Америки. Основной причиной такой формы носа является их питание. Муравьеды питаются исключительно муравьями и термитами, и их нос служит инструментом для ловли этих насекомых",
                R.drawable.anteater,"Численность малая"));
